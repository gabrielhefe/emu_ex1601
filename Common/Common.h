...
enum
{
	...
	CHARACTER_CREATE_RESULT_UN0xF3KNOWN					= 2,
...
enum PACKET_HEADCODE_DEF
{
	...
	HEADCODE_ACCOUNT_DATA = 0xF1,
		...
		SUBCODE_ACCOUNT_DATA_EVENT_ENTER_COUNT = 0xFD,
		SUBCODE_ACCOUNT_DATA_EVENT_NOTIFICATION = 0xFE,
	...
	HEADCODE_MISC_CHARACTER_DATA = 0xF3,
		...
		SUBCODE_MISC_CHARACTER_DATA_SECREC_KEY = 205,
		SUBCODE_MISC_CHARACTER_DATA_ADD_STATS = 239,
		SUBCODE_MISC_CHARACTER_REQUEST_SV_DATA = 240,
		SUBCODE_MISC_CHARACTER_DATA_SV_RANK_INFO = 241,
		SUBCODE_MISC_CHARACTER_DATA_RANK_TITLE = 242,
	...
	HEADCODE_QUEST_SUPPORT_NPC_TALK = 0xF9,
		SUBCODE_QUEST_FEREA_MINE = 0x10,
		SUBCODE_QUEST_FEREA_DOOR_OPEN_CLOSE = 0x11,
		SUBCODE_QUEST_FEREA_BOSS_EFFECT = 0x12,

	HEADCODE_ITEM_ACTION = 0xE8,
		SUBCODE_ITEM_ACTION_SPLIT_RESULT = 0x00,
		SUBCODE_ITEM_ACTION_ENHANCEMENT_RESULT = 0x01,

	HEADCODE_PET_TRAINER = 0x4C,
		SUBCODE_PET_TRAINER_MIX_1 = 0x10,
		SUBCODE_PET_TRAINER_MIX_2 = 0x11,
	
	HEADCODE_GOLDEN_ARCHER_LUCKY_NUMBER_VALUE = 0x95,
	HEADCODE_GOLDEN_ARCHER_LUCKY_NUMBER_OPEN = 0x94,

	HEADCODE_BASIC_DATA = 0x59,
		SUBCODE_BASIC_DATA_POSITION_ATTACK_RESULT = 0x01,
		SUBCODE_BASIC_DATA_HOW_TO_PLAY = 0x03,
		SUBCODE_BASIC_DATA_WARP_FAVORITE_LIST = 0x04,
		SUBCODE_BASIC_DATA_PROBABILITY_LOG = 0x05,
		SUBCODE_BASIC_DATA_WARP_MONSTER_INFO_HEAD = 0x06,

	HEADCODE_PERSONAL_STORE = 0x7C,
		SUBCODE_PERSONAL_STORE_LIST = 0x00,
		SUBCODE_PERSONAL_STORE_ITEM_LIST = 0x01,
		SUBCODE_PERSONAL_STORE_VIEW = 0x02,
		SUBCODE_PERSONAL_STORE_SEARCH_ITEM = 0x03,
		SUBCODE_PERSONAL_STORE_SELECT_ITEM = 0x04,
		SUBCODE_PERSONAL_STORE_PURCHASE_RESULT = 0x05,
		SUBCODE_PERSONAL_STORE_SELL_LIST = 0x06,
		SUBCODE_PERSONAL_STORE_SELL_ITEM_VIEW = 0x07,
		SUBCODE_PERSONAL_STORE_SELL_ITEM_RESULT = 0x08,
		SUBCODE_PERSONAL_STORE_SELL_ITEM_CANCEL = 0x09,
		SUBCODE_PERSONAL_STORE_STATE = 0x0A,
		SUBCODE_PERSONAL_STORE_ITEM_SOLD = 0x0C,
	
	HEADCODE_MERCHANT_DATA = 0x70,
		SUBCODE_MERCHANT_DATA_DARK_ANCIENT_ITEM_CREATE = 0x00,
		SUBCODE_MERCHANT_DATA_DARK_DARK_ANCIENT_ITEM_DESTROY = 0x01,
		SUBCODE_MERCHANT_DATA_OPEN = 0x11,
		SUBCODE_MERCHANT_DATA_REWARD = 0x12,
	
	HEADCODE_SOCKET_MIX_RESULT = 0x78,

	HEACODE_SOLDITEM_DATA = 0x6F,
		SUBCODE_SOLITEM_DATA_RECOVER_LIST_VIEW = 0x00,
		SUBCODE_SOLITEM_DATA_RECOVER_RESULT = 0x02,

	HEADCODE_PERSONAL_STORE_VIEWPORT = 0x3F,
		SUBCODE_PERSONAL_STORE_VIEWPORT = 0x00,
		SUBCODE_PERSONAL_STORE_VIEWPORT_CLOSE_RESULT = 0x03,
		SUBCODE_PERSONAL_STORE_VIEWPORT_TEXT_CHANGE_SEND = 0x10,

	HEADCODE_PENTAGRAM_ERRTEL = 0xEE,
		SUBCODE_PENTAGRAM_ERRTEL_DATA = 0x01,

	HEADCODE_PARTY_MATCHING = 0xEF,
		SUBCODE_PARTY_MATCHING_REGISTER_RESULT = 0x00,
		SUBCODE_PARTY_MATCHING_HANDLE_SEARCH = 0x01,
		SUBCODE_PARTY_MATCHING_JOIN_RESULT = 0x02,
		SUBCODE_PARTY_MATCHING_JOIN_DATA_RESULT = 0x03,
		SUBCODE_PARTY_MATCHING_JOIN_LIST = 0x04,
		SUBCODE_PARTY_MATCHING_ACCEPT_RESULT = 0x05,
		SUBCODE_PARTY_MATCHING_CANCEL_RESULT = 0x06,
		SUBCODE_PARTY_LEADER_CHANGE_RESULT = 0x07,
		SUBCODE_PARTY_MATCHING_JOIN_NOTIFY = 0x08,
		SUBCODE_PARTY_MATCHING_NOTIFY = 0x09,

	HEADCODE_MISC_DATA_ACTION = 0xEC,
		SUBCODE_MISC_DATA_JEWEL_INSERT = 0x00,
		SUBCODE_MISC_DATA_PENTAGRAM_JEWEL_REMOVE = 0x01,
		SUBCODE_MISC_DATA_MIX_PENTAGRAM_RESULT = 0x02,
		SUBCODE_MISC_DATA_JEWEL_UPGRADE = 0x03,
		SUBCODE_MISC_DATA_PENTAGRAM_JEWEL_RESULT_SEND = 0x04,
		SUBCODE_MISC_DATA_PENTAGRAM_UPGRADE_RACIANCE_SLOT_RESULT = 0x05,
		SUBCODE_MISC_DATA_WING_SOCKET_OPTION_ADD_RESULT = 0x06,
		SUBCODE_MISC_DATA_WING_SOCKET_OPTION_UPGRADE_RESULT = 0x07,
		SUBCODE_MISC_DATA_EARRING_UPGRADE_RESULT = 0x08,
		SUBCODE_MISC_DATA_MONSTER_LIFE_UPDATE_SEND = 0x10,
		SUBCODE_MISC_DATA_CHARACTER_STAT_DATA = 0x25,
		SUBCODE_MISC_DATA_CHARACTER_ELEMENTAL_DATA = 0x26,
		SUBCODE_MISC_DATA_CHARACTER_NEW_STAT = 0x29,
		SUBCODE_MISC_DATA_CHARACTER_ATTACK_SPEED_SEND = 0x30,
		SUBCOCE_MISC_DATA_HUNTING_RECORD = 0x50,
		SUBCOCE_MISC_DATA_HUNTING_RECORD_CLOSE = 0x51,
		SUBCODE_MISC_DATA_HUNTING_RECORD_SET_VISIBLE = 0x52,
		SUBCODE_MISC_HUNTING_RECORD_CURRENT_DAY = 0x53,
		SUBCODE_MISC_DATA_HUNTING_RIGHT_CLICK = 0x54,
		SUBCODE_MISC_DATA_HUNTING_RECORD_TIME = 0x55,
		SUBCODE_MISC_DATA_CHANNEL_WARP_RESULT = 0x56,
		SUBCODE_MISC_DATA_SEND_SERVER_LIST = 0x57,
		SUBCODE_MISC_DATA_SEND_KUBERA_MINE_CART = 0x61,

	HEADCODE_MINIMAP_DATA = 0xE7,
		SUBCODE_MINIMAP_DATA_PARTY_INFO = 0x01,
		SUBCODE_MINIMAP_DATA_INFO = 0x03,
		SUBCODE_MINIMAP_DATA_SKILL_DETECTION = 0x05,

	HEACODE_EVENT_INVENTORY = 0x4D,
		SUBCODE_EVENT_INVENTORY_ITEM_GET = 0x00,
		SUBCODE_EVENT_INVENTORY_ITEM_DROP_SEND = 0x01,
		SUBCODE_EVENT_INVENTORY_ITEM_DUR_SEND = 0x03,
		SUBCODE_EVENT_INVENTORY_ITEM_DELETE_SEND = 0x04,
		SUBCODE_EVENT_INVENTORY_ITEM_MODIFY_SEND = 0x05,
		SUBCODE_EVENT_INVENTORY_ITEM_CHANGE_SEND = 0x06,
		SUBCODE_EVENT_INVENTORY_INVENTORY_OPEN_SEND = 0x0F,

		SUBCODE_EVENT_INVENTORY_MU_ROOMY_START_REQUEST = 0x10,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_REVEAL_CARD_RESULT = 0x11,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_CARD_MOVE_RESULT = 0x12,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_CARD_REMOVE_RESULT = 0x13,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_MATCH_RESULT = 0x14,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_END_RESULT = 0x15,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_CARD_LIST = 0x16,
		SUBCODE_EVENT_INVENTORY_MU_ROOMY_MESSAGE = 0x17,

		SUBCODE_EVENT_INVENTORY_ENABLE_SEND = 0x18,

		SUBCODE_EVENT_INVENTORY_MINI_BOMB_START_RESULT = 0x23,
		SUBCODE_EVENT_INVENTORY_MINIBOMB_REVEAL = 0x24,
		SUBCODE_EVENT_INVENTORY_MINI_BOMB_MARK_RESULT = 0x25,
		SUBCODE_EVENT_INVENTORY_MINIBOMB_RESULT = 0x26,
		SUBCODE_EVENT_INVENTORY_MINIBOMB_OPEN = 0x27,
		SUBCODE_EVENT_INVENTORY_MINI_BOMB_GIFT_RESULT = 0x28,
		SUBCODE_EVENT_INVENTORY_MINI_BOMB_CREATE_CELL = 0x29,

		SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_STATE = 0x2A,
		SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_INFO = 0x2B,
		SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_BOX_SELECT = 0x2C,
		SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_PLAY_INFO = 0x2D,
		SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_PLAY_RESULT = 0x2E,

		SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_START = 0x30,
		SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_0x4D_0x31 = 0x31,
		SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_OPEN = 0x33,
		SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_RESULT = 0x34,

		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_PURCHASE_LIST = 0x40,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_STATUS = 0x41,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_RUUD_NPC = 0x42,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_PACKET_43_HEAD = 0x43,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_MONSTER_SOUL_ITEM_MOVE = 0x44,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_UPDATE_DATA = 0x45,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_AVAILABLE_PURCHASE = 0x46,
		SUBCODE_EVENT_INVENTORY_MONSTER_SOUL_MONSTER_SOUL_REWARD = 0x47,

	HEADCODE_GUILD_MATCHING = 0xED,
		SUBCODE_GUILD_MATCHING_LIST = 0x00,
		SUBCODE_GUILD_MATCHING_LIST_SEARCH = 0x01,
		SUBCODE_GUILD_MATCHING_REGISTER_RESULT = 0x02,
		SUBCODE_GUILD_MATCHING_CANCEL_REGISTER_RESULT = 0x03,
		SUBCODE_GUILD_MATCHING_JOIN_RESULT = 0x04,
		SUBCODE_GUILD_MATCHING_JOIN_CANCEL_RESULT = 0x05,
		SUBCODE_GUILD_MATCHING_JOIN_ACCEPT_RESULT = 0x06,
		SUBCODE_GUILD_MATCHING_JOIN_LIST = 0x07,
		SUBCODE_GUILD_MATCHING_JOIN_INFO_RESULT = 0x08,
		SUBCODE_GUILD_MATCHING_NOTIFY = 0x09,
		SUBCODE_GUILD_GUILD_MATCHING_NOTIFY_MASTER = 0x10,

	HEADCODE_CHAT_BLOCK = 0x6E,

	HEADCODE_MUUN_DATA = 0x4E,
		SUBCODE_MUUN_ITEM_GET = 0x00,
		SUBCODE_MUUN_ITEM_DUR = 0x03,
		SUBCODE_MUUN_ITEM_DELETE = 0x04,
		SUBCODE_MUUN_ITEM_MODIFY = 0x05,
		SUBCODE_MUUN_ITEM_CHANGE = 0x06,
		SUBCODE_MUUN_ITEM_STATUS = 0x07,
		SUBCODE_MUUN_ITEM_USE = 0x08,
		SUBCODE_MUUN_ITEM_SELL = 0x09,
		SUBCODE_MUUN_ATTACK = 0x12,
		SUBCODE_MUUN_EXCHANGE = 0x13,
		SUBCODE_MUUN_MOUNT = 0x14,
		SUBCODE_MUUN_EXPIRE_SEND = 0x20,
		SUBCODE_MUUN_EXPIRE_DATE = 0x21,
		SUBCODE_MUUN_EXPIRE_UPDATE = 0x22,
		SUBCODE_MUUN_DISPLAY_SLOT_VIEWPORT = 0x23,

	CLIENT_CONNECT_CUSTOM_HEADER = 0xFA,

	HEADCODE_CUSTOM = 0xFF,
		SUBCODE_CUSTOM_RANKTITLE = 0x01,
		SUBCODE_CUSTOM_SEND_RANK_SERVER_DATA = 0x02,
};
