...
constexpr char* CASTLE_SIEGE_FILEPATH = "../Data/Event/CastleSiege/CastleSiege.ini";
constexpr char* CASTLE_SIEGE_SECTION = "CastleSiege";
constexpr char* CASTLE_SIEGE_SECTION_REGISTER = "Register";
