...
constexpr char* CHAOS_CASTLE_FILEPATH = "../Data/Event/ChaosCastle/ChaosCastle.ini";
constexpr char* CHAOS_CASTLE_SECTION = "ChaosCastle";
constexpr char* CHAOS_CASTLE_SECTION_SURVIVAL = "Survival";
