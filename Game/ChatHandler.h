...
class ChatHandler
{
	public:
		...
		void CommandClearInventory(const char* msg);
		void CommandClearGremoryCase(const char* msg);
		void CommandAddExpandedInventoryWareHouse(const char* msg);
		void CommandAdminNotify(const char* msg);
		void CommandAdminDeleteItemServer(const char* msg);
		void CommandAdminDeleteItemServerSerial(const char* msg);
		void CommandAdminDeleteItemErrorPersonal(const char* msg);

		void CommandDanhLo(const char* msg);
		void CommandDanhDe(const char* msg);
		void CommandNhanThuongLoDe(const char* msg);

		void CommandGold(const char * msg);
		void CommanResetCharacter(const char* msg);
		void CommanAutoResetCharacter(const char* msg);
		void CommandCmdList(const char* msg);
		...
		void CommandItemAddPlayer(const char * msg);
		...
		void CommandKickAccount(const char* msg);
		...
		void CommandTestFunc(const char* msg);
