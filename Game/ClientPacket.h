...
struct PERSONAL_STORE_ITEM_SOLD : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE, SUBCODE_PERSONAL_STORE_ITEM_SOLD, sizeof(PERSONAL_STORE_ITEM_SOLD));
...
struct PERSONAL_STORE_STATE_RESULT : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE, SUBCODE_PERSONAL_STORE_STATE, sizeof(PERSONAL_STORE_STATE_RESULT));
	}
...
struct PERSONAL_STORE_STATE : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE, SUBCODE_PERSONAL_STORE_STATE, sizeof(PERSONAL_STORE_STATE));
		this->data = -1;
		this->state = 1;
		memset(this->seller, 0, MAX_CHARACTER_LENGTH + 1);
...
struct PERSONAL_STORE_SELL_ITEM_CANCEL : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE, SUBCODE_PERSONAL_STORE_SELL_ITEM_CANCEL, sizeof(PERSONAL_STORE_SELL_ITEM_CANCEL));
	}
...
struct PERSONAL_STORE_SELL_ITEM_RESULT : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE, SUBCODE_PERSONAL_STORE_SELL_ITEM_RESULT, sizeof(PERSONAL_STORE_SELL_ITEM_RESULT));
		this->data = 0;
		this->result = 0;
	}
...
struct PERSONAL_STORE_PURCHASE_RESULT : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE, SUBCODE_PERSONAL_STORE_PURCHASE_RESULT, sizeof(PERSONAL_STORE_PURCHASE_RESULT));
	}
...
struct ITEM_ENHANCEMENT_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_ITEM_ACTION, SUBCODE_ITEM_ACTION_ENHANCEMENT_RESULT, sizeof(ITEM_ENHANCEMENT_RESULT));
		this->unk = 0;
		this->result = 0;
	}
...
struct PET_TRAINER_MIX_2_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PET_TRAINER, SUBCODE_PET_TRAINER_MIX_2, sizeof(PET_TRAINER_MIX_2_RESULT));
		this->result = 0;
	}
...
struct PET_TRAINER_MIX_1_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PET_TRAINER, SUBCODE_PET_TRAINER_MIX_1, sizeof(PET_TRAINER_MIX_1_RESULT));
		this->type = 0;
		this->result = 0;
	}
...
struct EARRING_UPGRADE_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_EARRING_UPGRADE_RESULT, sizeof(EARRING_UPGRADE_RESULT));
		this->result = 0;
	}
...
struct PACKET_CHANNEL_WARP_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_CHANNEL_WARP_RESULT, sizeof(PACKET_CHANNEL_WARP_RESULT));
		this->result = 1;
	}
...
struct PACKET_GOLDEN_ARCHER_LUCKY_NUMBER_VALUE
{
	...
	{
		this->h.set(HEADCODE_GOLDEN_ARCHER_LUCKY_NUMBER_VALUE, sizeof(PACKET_GOLDEN_ARCHER_LUCKY_NUMBER_VALUE));
	}
...
struct PACKET_GOLDEN_ARCHER_LUCKY_NUMBER_OPEN
{
	...
	{
		this->h.set(HEADCODE_GOLDEN_ARCHER_LUCKY_NUMBER_OPEN, sizeof(PACKET_GOLDEN_ARCHER_LUCKY_NUMBER_OPEN));
	}
...
struct PACKET_PROBABILITY_LOG
{
	...
	{
		this->h.set(HEADCODE_BASIC_DATA, SUBCODE_BASIC_DATA_PROBABILITY_LOG, sizeof(PACKET_PROBABILITY_LOG));
	}
...
struct PACKET_HOW_TO_PLAY
{
	PACKET_HOW_TO_PLAY()
	{
		this->h.set(HEADCODE_BASIC_DATA, SUBCODE_BASIC_DATA_HOW_TO_PLAY, sizeof(PACKET_HOW_TO_PLAY));
		this->data = 0;
	}
...
struct PACKET_POSITION_ATTACK_RESULT
{
	...
	{
		this->h.set(HEADCODE_BASIC_DATA, SUBCODE_BASIC_DATA_POSITION_ATTACK_RESULT, sizeof(PACKET_POSITION_ATTACK_RESULT));
	}
...
struct WING_SOCKET_OPTION_UPGRADE_RESULT
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_WING_SOCKET_OPTION_UPGRADE_RESULT, sizeof(WING_SOCKET_OPTION_UPGRADE_RESULT));
		this->slot = 0;
		this->result = result;
	}
...
struct WING_SOCKET_OPTION_ADD_RESULT
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_WING_SOCKET_OPTION_ADD_RESULT, sizeof(WING_SOCKET_OPTION_ADD_RESULT));
		this->result = result;
	}
...
struct HUNTING_RECORD_SET_VISIBLE : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_HUNTING_RECORD_SET_VISIBLE, sizeof(HUNTING_RECORD_SET_VISIBLE));
		this->result = result;
	}
...
struct ITEM_SPLIT_RESULT
{
	ITEM_SPLIT_RESULT()
	{
		this->h.set(HEADCODE_ITEM_ACTION, sizeof(ITEM_SPLIT_RESULT));
		this->id = 0;
		this->result = 0;
	}
...
struct FEREA_MINE
{
	FEREA_MINE()
	{
		this->h.set(HEADCODE_QUEST_SUPPORT_NPC_TALK, SUBCODE_QUEST_FEREA_MINE, sizeof(FEREA_MINE));
		this->x = 0;
		this->y = 0;
		this->type = 0;
	}
...
struct FEREA_BOSS_EFFECT
{
	FEREA_BOSS_EFFECT()
	{
		this->h.set(HEADCODE_QUEST_SUPPORT_NPC_TALK, SUBCODE_QUEST_FEREA_BOSS_EFFECT, sizeof(FEREA_BOSS_EFFECT));
	}
...
struct FEREA_DOOR_OPEN_CLOSE
{
	...
	{
		this->h.set(HEADCODE_QUEST_SUPPORT_NPC_TALK, SUBCODE_QUEST_FEREA_DOOR_OPEN_CLOSE, sizeof(FEREA_DOOR_OPEN_CLOSE));
		this->closed = closed;
	}
...
struct WARP_FAVORITE_LIST
{
	WARP_FAVORITE_LIST()
	{
		this->h.set(HEADCODE_BASIC_DATA, SUBCODE_BASIC_DATA_WARP_FAVORITE_LIST, sizeof(WARP_FAVORITE_LIST));
		this->count = 0;
...
struct EVENT_ENTER_COUNT
{
	...
	{
		this->h.set(HEADCODE_ACCOUNT_DATA, SUBCODE_ACCOUNT_DATA_EVENT_ENTER_COUNT, sizeof(EVENT_ENTER_COUNT));
		this->type = type;
...
struct DARK_ANCIENT_ITEM_CREATE
{
	...
	{
		this->h.set(HEADCODE_MERCHANT_DATA, SUBCODE_MERCHANT_DATA_DARK_ANCIENT_ITEM_CREATE, sizeof(DARK_ANCIENT_ITEM_CREATE));
		this->result = 0;
		this->slot = 0;
	}
...
struct DARK_ANCIENT_ITEM_DESTROY
{
	...
	{
		this->h.set(HEADCODE_MERCHANT_DATA, SUBCODE_MERCHANT_DATA_DARK_DARK_ANCIENT_ITEM_DESTROY, sizeof(DARK_ANCIENT_ITEM_DESTROY));
		this->result = 0;
	}
...
struct HUNTING_RECORD_TIME /* 0xEC 0x55 */
{
	HUNTING_RECORD_TIME()
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_HUNTING_RECORD_TIME, sizeof(HUNTING_RECORD_TIME));
		this->time = 0;
		this->damage = 0;
...
struct HUNTING_RECORD_CURRENT_DAY
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_HUNTING_RECORD_CURRENT_DAY, sizeof(HUNTING_RECORD_CURRENT_DAY));
		this->id = 0;
		this->year = 0;
		this->month = 0;
		this->day = 0;
...
struct SOCKET_MIX_RESULT
{
	...
	{
		this->h.set(HEADCODE_SOCKET_MIX_RESULT, sizeof(SOCKET_MIX_RESULT));
		this->unk = 1;
		this->result = result;
...
struct SOLD_ITEM_RECOVER_RESULT
{
	...
	{
		this->h.set(HEACODE_SOLDITEM_DATA, SUBCODE_SOLITEM_DATA_RECOVER_RESULT, sizeof(SOLD_ITEM_RECOVER_RESULT));
		this->result = 0;
	}
...
struct MIX_PENTAGRAM_RESULT
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_MIX_PENTAGRAM_RESULT, sizeof(MIX_PENTAGRAM_RESULT));
		this->result = result;
		this->gremory = gremory;
	}
	PBMSG_HEAD2 h;
...
struct CHARACTER_SPECIALIZATION_STAT
{
	...
	{
		this->h.set(HEADCODE_BASIC_DATA, 0x00, sizeof(CHARACTER_SPECIALIZATION_STAT));
...
struct EVENT_NOTIFICATION
{
	...
	{
		this->h.set(HEADCODE_ACCOUNT_DATA, SUBCODE_ACCOUNT_DATA_EVENT_NOTIFICATION, sizeof(EVENT_NOTIFICATION));
...
struct PARTY_LEADER_CHANGE_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_LEADER_CHANGE_RESULT, sizeof(PARTY_LEADER_CHANGE_RESULT));
		this->result = result;
		this->unk = 0;
	}
...
struct CHARACTER_NEW_STAT
{
	CHARACTER_NEW_STAT()
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_CHARACTER_NEW_STAT, sizeof(CHARACTER_NEW_STAT));
	}
	PBMSG_HEAD2 h;
...
struct CHARACTER_STAT_DATA
{
	CHARACTER_STAT_DATA()
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_CHARACTER_STAT_DATA, sizeof(CHARACTER_STAT_DATA));
		this->strength = 0;
		this->strength_add = 0;
		this->agility = 0;
		this->agility_add = 0;
...
struct CHARACTER_ELEMENTAL_DATA
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_CHARACTER_ELEMENTAL_DATA, sizeof(CHARACTER_ELEMENTAL_DATA));
	}
...
struct MONSTER_LIFE_UPDATE_SEND
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_MONSTER_LIFE_UPDATE_SEND, sizeof(MONSTER_LIFE_UPDATE_SEND));
...
struct LIFE_SEND : C1_HEADER
{
	...
	{
		this->Set(HEADCODE_REFILL_HP_SHIELD, sizeof(LIFE_SEND));
		this->type = type;
		this->flag = 0;
...
struct MANA_SEND : C1_HEADER
{
	...
	{
		this->Set(HEADCODE_REFILL_MANA_STAMINA, sizeof(MANA_SEND));
		this->type = type;
...
struct CHARACTER_ATTACK_SPEED_SEND
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_CHARACTER_ATTACK_SPEED_SEND, sizeof(CHARACTER_ATTACK_SPEED_SEND));
...
struct PENTAGRAM_UPGRADE_RACIANCE_SLOT_RESULT
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_PENTAGRAM_UPGRADE_RACIANCE_SLOT_RESULT, sizeof(PENTAGRAM_UPGRADE_RACIANCE_SLOT_RESULT));
		this->result = 1;
	}
...
struct PENTAGRAM_JEWEL_INSERT_SEND
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_JEWEL_INSERT, sizeof(PENTAGRAM_JEWEL_INSERT_SEND));
		this->result = 0;
	}
...
struct PMSG_PENTAGRAM_JEWEL_REMOVE_SEND
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_PENTAGRAM_JEWEL_REMOVE, sizeof(PMSG_PENTAGRAM_JEWEL_REMOVE_SEND));
		this->result = 0;
		this->type = 0;
		this->index = 0;
	}
...
struct PMSG_PENTAGRAM_JEWEL_RESULT_SEND
{
	...
	{
		this->h.set(HEADCODE_MISC_DATA_ACTION, SUBCODE_MISC_DATA_PENTAGRAM_JEWEL_RESULT_SEND, sizeof(PMSG_PENTAGRAM_JEWEL_RESULT_SEND));
		this->result = result;
	}
...
struct CHAOS_MIX_ITEM
{
	...
	{
		this->h.set(HEADCODE_CLOSE_INTERFACE, sizeof(CHAOS_MIX_ITEM));
		this->type = type;
		this->count = 0;
	}
	PWMSG_HEAD h;
...
struct CHAOS_MIX_ITEM_SINGLE
{
	...
	{
		this->h.set(HEADCODE_CLOSE_INTERFACE, sizeof(CHAOS_MIX_ITEM_SINGLE));
		this->type = type;
		this->count = 0;
		this->slot = -1;
...
struct PERSONAL_STORE_TEXT_CHANGE_SEND : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE_VIEWPORT, SUBCODE_PERSONAL_STORE_VIEWPORT_TEXT_CHANGE_SEND, sizeof(PERSONAL_STORE_TEXT_CHANGE_SEND));
		memset(this->description, 0, PERSONAL_STORE_NAME_LENGTH + 1);
		memset(this->seller, 0, MAX_CHARACTER_LENGTH + 1);
	}
...
struct PERSONAL_STORE_CLOSE_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE_VIEWPORT, SUBCODE_PERSONAL_STORE_VIEWPORT_CLOSE_RESULT, sizeof(PERSONAL_STORE_CLOSE_RESULT));
	}
...
struct PERSONAL_STORE_VIEWPORT : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PERSONAL_STORE_VIEWPORT, SUBCODE_PERSONAL_STORE_VIEWPORT, sizeof(PERSONAL_STORE_VIEWPORT));
		this->count = 1;
		memset(this->description, 0, PERSONAL_STORE_NAME_LENGTH + 1);
	}
...
struct CHARACTER_ADDSTAT : C2_HEADER_SUB {
	BYTE Type;
};

struct CHARACTER_ADDSTAT_BODY{
	WORD Points;
	WORD Level;
};
