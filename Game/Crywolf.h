...
constexpr char* CRYWOLF_FILEPATH = "../Data/Event/Crywolf/Crywolf.ini";
constexpr char* CRYWOLF_SECTION = "Crywolf";
constexpr char* CRYWOLF_SECTION_AI = "AIChange";
constexpr char* CRYWOLF_SECTION_ALTAR = "Altar";
constexpr char* CRYWOLF_SECTION_BALGASS = "Balgass";
constexpr char* CRYWOLF_SECTION_BENEFIT = "Benefit";
constexpr char* CRYWOLF_SECTION_PENALTY = "Penalty";
