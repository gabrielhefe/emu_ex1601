...
constexpr char* DEVIL_SQUARE_FILEPATH = "../Data/Event/DevilSquare/DevilSquare.ini";
constexpr char* DEVIL_SQUARE_SECTION = "DevilSquare";
...
class DevilSquareMgr: public EventCommonMgr
{
	...
	public:
		...
		void LoadDevilSquareIni();
		void LoadDevilSquareSetting();
		void LoadDevilSquareRanking(char* pchFileName);
