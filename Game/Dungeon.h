...
constexpr char* DUNGEON_FILEPATH = "../Data/Event/Dungeon/Dungeon.ini";
constexpr char* DUNGEON_SECTION = "Dungeon";
constexpr char* DUNGEON_RACE_SECTION = "DungeonRace";
...
class Dungeon
{
	...
	public:
		...
		void LoadIni();
		void LoadInstance(char* pchFileName);
