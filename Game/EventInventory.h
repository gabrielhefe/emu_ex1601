...
constexpr char* EVENTINVENTORY_FILEPATH = "../Data/Event/Eventinventory/EventInventory.ini";
constexpr char* EVENTINVENTORY_SECTION = "EventInventory";
constexpr char* EVENTINVENTORY_SECTION_MINIBOMB = "MiniBomb";
constexpr char* EVENTINVENTORY_SECTION_JEWELBINGO = "JewelBingo";
constexpr char* EVENTINVENTORY_SECTION_MUROOMY = "MuRoomy";
constexpr char* EVENTINVENTORY_SECTION_BASEBALL = "NumericBaseball";
...
struct PMSG_EVENT_ITEM_GET_RECV
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_GET, sizeof(PMSG_EVENT_ITEM_GET_RECV));
	}
...
struct PMSG_EVENT_ITEM_GET_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_GET, sizeof(PMSG_EVENT_ITEM_GET_SEND));
	}
...
struct PMSG_EVENT_ITEM_DROP_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_DROP_SEND, sizeof(PMSG_EVENT_ITEM_DROP_SEND));
	}
...
struct PMSG_EVENT_ITEM_DUR_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_DUR_SEND, sizeof(PMSG_EVENT_ITEM_DUR_SEND));
	}
...
struct PMSG_EVENT_ITEM_DELETE_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_DELETE_SEND, sizeof(PMSG_EVENT_ITEM_DELETE_SEND));
	}
...
struct PMSG_EVENT_ITEM_MODIFY_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_MODIFY_SEND, sizeof(PMSG_EVENT_ITEM_MODIFY_SEND));
	}
...
struct PMSG_EVENT_ITEM_CHANGE_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ITEM_CHANGE_SEND, sizeof(PMSG_EVENT_ITEM_CHANGE_SEND));
	}
...
struct PMSG_EVENT_INVENTORY_OPEN_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_INVENTORY_OPEN_SEND, sizeof(PMSG_EVENT_INVENTORY_OPEN_SEND));
		this->result = 0;
		this->id = 0;
...
struct PMSG_EVENT_INVENTORY_ENABLE_SEND
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_ENABLE_SEND, sizeof(PMSG_EVENT_INVENTORY_ENABLE_SEND));
	}
