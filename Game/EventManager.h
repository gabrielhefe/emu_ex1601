...
class CEventMgr
{
	...
	public:
		...
		void LoadEventData(char* pchFileName);
		void LoadEventSeasonData(char* pchFileName);
		void LoadEventContributionReward(char* pchFileName);
		void LoadEventLevel(char* pchFileName);
		void LoadEventEnterCount(char* pchFileName);
