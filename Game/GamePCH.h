...
#include "ResetSystemMgr.h"
#include "DynamicExperienceMgr.h"
#include "DuelBetItem.h"
...
#include "CustomRankTitle.h"
#include "CustomRankServer.h"
...
#define sResetSystemMgr SingNull(CResetMgr)
#define sDynamicExperienceMgr SingNull(CDynamicExpMgr)
#define sDuelBetItem SingNull(CDuelBetIem)
#define sCustomRankTitle SingNull(CCustomRankTitle)
...
#define sCustomRankServer SingNull(CCustomRankServer)
#define sNoticeSystem SingNull(CNoticeSystem)
#define sDiscord SingNull(Discord)
#endif