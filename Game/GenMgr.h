...
constexpr char* GENS_FILEPATH = "../Data/Gens/Gens.ini";
constexpr char* GENS_SECTION = "Gens";
...
class CGenMgr
{
	...
	public:
		...
		void LoadIni();
		void LoadGenReward(char* pchFileName);
		void LoadGenRanking(char* pchFileName);
		void LoadGenKillPoints(char* pchFileName);
