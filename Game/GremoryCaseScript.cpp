...
void GremoryCaseScript::SaveDB(SQLTransaction & trans, uint8 rules)
{
	...
	this->GetPlayer()->SaveGremoryCaseAccBinary();
	this->GetPlayer()->SaveGremoryCaseCharaBinary();
	this->GetPlayer()->SaveGremoryCaseMobileBinary();
	this->GetPlayer()->SaveGremoryCasePSBinary();
}
...
void GremoryCaseScript::LoadDBItemNew(const char* ItemArray, uint32 owner, ItemBox box)
{
