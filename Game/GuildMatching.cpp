...
void GuildMatching::DGGuildMatchingListRecv(uint8 * Packet)
{
	...
	head->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_LIST, sizeof(GUILD_MATCHING_LIST_HEAD)+(head->count * sizeof(GUILD_MATCHING_LIST_BODY)));
...
void GuildMatching::DGGuildMatchingJoinListRecv(uint8 * Packet)
{
	...
	head->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_JOIN_LIST, sizeof(GUILD_MATCHING_JOIN_LIST_HEAD)+(head->count * sizeof(GUILD_MATCHING_JOIN_LIST_BODY)));
