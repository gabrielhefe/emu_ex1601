...
struct GUILD_MATCHING_REGISTER_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_REGISTER_RESULT, sizeof(GUILD_MATCHING_REGISTER_RESULT));
		this->result = result;
	}
...
struct GUILD_MATCHING_CANCEL_REGISTER_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_CANCEL_REGISTER_RESULT, sizeof(GUILD_MATCHING_CANCEL_REGISTER_RESULT));
		this->result = result;
	}
...
struct GUILD_MATCHING_JOIN_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_JOIN_RESULT, sizeof(GUILD_MATCHING_JOIN_RESULT));
		this->result = result;
	}
...
struct GUILD_MATCHING_JOIN_CANCEL_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_JOIN_CANCEL_RESULT, sizeof(GUILD_MATCHING_JOIN_CANCEL_RESULT));
	}
...
struct GUILD_MATCHING_JOIN_ACCEPT_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_JOIN_ACCEPT_RESULT, sizeof(GUILD_MATCHING_JOIN_ACCEPT_RESULT));
		this->type = type;
		this->result = result;
...
struct GUILD_MATCHING_JOIN_LIST_HEAD : C2_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_JOIN_LIST, sizeof(GUILD_MATCHING_JOIN_LIST_HEAD));
	}
...
struct GUILD_MATCHING_JOIN_INFO_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_JOIN_INFO_RESULT, sizeof(GUILD_MATCHING_JOIN_INFO_RESULT));
	}
...
struct GUILD_MATCHING_NOTIFY : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_MATCHING_NOTIFY, sizeof(GUILD_MATCHING_NOTIFY));
	}
...
struct GUILD_MATCHING_NOTIFY_MASTER : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_GUILD_MATCHING, SUBCODE_GUILD_GUILD_MATCHING_NOTIFY_MASTER, sizeof(GUILD_MATCHING_NOTIFY_MASTER));
	}
