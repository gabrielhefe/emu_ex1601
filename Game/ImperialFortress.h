...
constexpr char* FORTRESS_FILEPATH = "../Data/Event/ImperialFortress/ImperialFortress.ini";
constexpr char* FORTRESS_SECTION = "ImperialFortress";
...
class ImperialFortressMgr
{
	...
	public:
		...
		void LoadIni();
		void LoadImperialFortressLevel(char* pchFileName);
		void LoadImperialFortressMonsterSettings(char* pchFileName);
		void LoadImperialFortressTraps(char* pchFileName);
