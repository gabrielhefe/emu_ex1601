...
struct item_template
{
	...
	DECLARE_PROPERTY_ARRAY(uint64, RequiredStat, MAX_STAT_TYPE);
...
struct MysteriousStoneItem {
	DECLARE_ENUM(uint16, LuckRate);
	DECLARE_RANGE(uint8, AddExl);
	DECLARE_ENUM(uint16, Ancient2Rate);
	DECLARE_ENUM(uint16, UpAncientRate);
};
...
class CItemMgr
{
	...
	public:
		...
		void LoadItemTemplate(char* pchFileName);
		void LoadItemAddOption(char* pchFileName);
		void LoadItemSetType(char* pchFileName);
		void LoadItemSetOption(char* pchFileName);
		void LoadItemHarmony(char* pchFileName);
		void LoadItemHarmonyEnhancement(char* pchFileName);
		void LoadItemSocket(char* pchFileName);
		void LoadItemSocketSeed(char* pchFileName);
		void LoadItemSocketBonus(char* pchFileName);
		void LoadItemSocketPackage(char* pchFileName);
		void LoadItemSocketMix(char* pchFileName);
		void LoadItemSocketUpgrade(char* pchFileName);
		void LoadItemSocketSeedSphere(char* pchFileName);
		void LoadItemTransformation(char* pchFileName);
		void LoadItemDrop(char* pchFileName);
		void LoadItemLevelTemplate(char* pchFileName);
		void LoadItemMixLucky(char* pchFileName);
		void LoadItemPriceData(char* pchFileName);
		void LoadItemStack(char* pchFileName);
		void LoadItemQuest(char* pchFileName);
		void LoadItemPriceRuud(char* pchFileName);
		void LoadItemWingValues(char* pchFileName);
		void LoadItemReducedDrop(char* pchFileName);
		void LoadItemCreateData(char* pchFileName);
		void LoadItemFlagDB(char* pchFileName);
		void LoadItemWingGradedOption(char* pchFileName);
		void LoadItemWingSocketOption(char* pchFileName);
		void LoadItemWingSocketUpgrade(char* pchFileName);
		void LoadEarring(char* pchFileName);
		void LoadEarringOption(char* pchFileName);
		void LoadEarringBonus(char* pchFileName);
		void LoadEarringUpgrade(char* pchFileName);
		void LoadMasteryBonus(char* pchFileName);
		void LoadMysteriousStone(char* pchFileName);
		void LoadGuardianOption(char* pchFileName);
		...
		void TestTranf(Player* pPlayer,uint8 skin);
	...
	#define option_serial uint8 skill, uint8 luck, uint8 option, uint8 exe, uint8 ancient, uint8 * socket
		...
		MysteriousStoneItem m_mysteriouse_stone_data[3];
};
