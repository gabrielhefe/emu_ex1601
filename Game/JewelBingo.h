...
struct JEWEL_BINGO_STATE
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_STATE, sizeof(JEWEL_BINGO_STATE));
		this->state = state;
	}
...
struct JEWEL_BINGO_INFO
{
	JEWEL_BINGO_INFO()
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_INFO, sizeof(JEWEL_BINGO_INFO));
		this->result = 0;
...
struct JEWEL_BINGO_BOX_SELECT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_BOX_SELECT, sizeof(JEWEL_BINGO_BOX_SELECT));
	}
...
struct JEWEL_BINGO_PLAY_INFO
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_PLAY_INFO, sizeof(JEWEL_BINGO_PLAY_INFO));
		this->result = 0;
		memset(this->grid, 0, JEWEL_BINGO_GRID_SIZE);
...
struct JEWEL_BINGO_PLAY_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_JEWEL_BINGO_PLAY_RESULT, sizeof(JEWEL_BINGO_PLAY_RESULT));
		memset(this->grid, 0, JEWEL_BINGO_GRID_SIZE);
		memset(this->matching_jewel, 0, JEWEL_BINGO_MATCHING_SIZE);
		this->score1 = 0;
		this->score2 = 0;
