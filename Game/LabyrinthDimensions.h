...
constexpr char* LABYRITNTH_FILEPATH = "../Data/Event/Labyrinth/Labyrinth.ini";
constexpr char* LABYRITNTH_SECTION = "Labyrinth";
...
class LabyrinthDimensions
{
	...
	public:
		...
		void LoadIni();
		void LoadInfo(char* pchFileName);
		void LoadMission(char* pchFileName);
		void LoadArea(char* pchFileName);
		void LoadAreaData(char* pchFileName);
		void LoadLevel(char* pchFileName);
