...
struct MINI_BOMB_START_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MINI_BOMB_START_RESULT, sizeof(MINI_BOMB_START_RESULT));
		this->result = result;
	}
...
struct MINI_BOMB_REVEAL_HEAD
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MINIBOMB_REVEAL, sizeof(MINI_BOMB_REVEAL_HEAD));
	}
...
struct MINI_BOMB_MARK_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MINI_BOMB_MARK_RESULT, sizeof(MINI_BOMB_MARK_RESULT));
		this->cell = 0;
		this->result = result;
		this->remain_bombs = 0;
	}
...
struct MINI_BOMB_GIFT_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MINI_BOMB_GIFT_RESULT, sizeof(MINI_BOMB_GIFT_RESULT));
		this->result = result;
	}
...
struct MINI_BOMB_CREATE_CELL
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MINI_BOMB_CREATE_CELL, sizeof(MINI_BOMB_CREATE_CELL));
		this->y = 0;
		this->x = 0;
		this->effect = 0;
