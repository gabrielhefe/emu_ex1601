...
struct NPCHandleList {
	DECLARE_ENUM(uint16, NpcID);
	DECLARE_PROPERTY_STRING(ScriptName);
};

typedef std::list<NPCHandleList*> NPCHandleData;
...
class MonsterManager
{
	...
	public:
		...
		void LoadNpcHandleList(char* pchFileName);
		void LoadMonsterTemplate(char* pchFileName);
		void LoadMonsterItems();
		void LoadMonsterSkill(char* pchFileName);
		void LoadMonsterSkillSpecial(char* pchFileName);
		void LoadMonsterAIElement(char* pchFileName);
		void LoadMonsterAIAutomata(char* pchFileName);
		void LoadMonsterAIUnit(char* pchFileName);
		void LoadMonsterAIGroup(char* pchFileName);
		void LoadMonsterRespawnLocation(char* pchFileName);
		void LoadMonsterEquipment(char* pchFileName);
		void LoadMonster(char* pchFileName);
		void AddMonsterSpawn(uint32 GUID, uint16 ID, uint16 World, uint16 X1, uint16 Y1, uint16 X2, uint16 Y2, uint8 Dir, uint16 MoveDistance, std::string NpcFunction , uint8 Element);
		void LoadMonsterEvent(char* pchFileName);
		void LoadMonsterRespawn();
		void LoadMonsterExclusive(char* pchFileName);
