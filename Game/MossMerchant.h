...
#define MOSS_MERCHANT_SECTION_MAX			11
#define MOSS_MERCHANT_REQUIRED_ITEM_MAX		3
...
struct MOSS_MERCHANT_REWARD
{
	...
	{
		this->h.set(HEADCODE_MERCHANT_DATA, SUBCODE_MERCHANT_DATA_REWARD, sizeof(MOSS_MERCHANT_REWARD));
...
struct MossMerchantSection
{
	...
	DECLARE_PROPERTY_ARRAY(uint16, RequiredItemType, MOSS_MERCHANT_REQUIRED_ITEM_MAX);
	DECLARE_PROPERTY_ARRAY(uint32, RequiredItemCount, MOSS_MERCHANT_REQUIRED_ITEM_MAX);
