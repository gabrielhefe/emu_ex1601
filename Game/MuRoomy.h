...
struct MU_ROOMY_START_REQUEST
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_START_REQUEST, sizeof(MU_ROOMY_START_REQUEST));
		this->type = 0;
	}
...
struct MU_ROOMY_START_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_START_REQUEST, sizeof(MU_ROOMY_START_RESULT));
		this->scoreH = 0;
		this->scoreL = 0;
		this->card_count = 0;
...
struct MU_ROOMY_REVEAL_CARD_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_REVEAL_CARD_RESULT, sizeof(MU_ROOMY_REVEAL_CARD_RESULT));
		this->card_count = 0;
		this->special_card_count = 0;
	};
...
struct MU_ROOMY_CARD_MOVE_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_CARD_MOVE_RESULT, sizeof(MU_ROOMY_CARD_MOVE_RESULT));
		this->source_slot = -1;
		this->target_slot = -1;
		this->color = -1;
		this->number = -1;
...
struct MU_ROOMY_CARD_REMOVE_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_CARD_REMOVE_RESULT, sizeof(MU_ROOMY_CARD_REMOVE_RESULT));
		this->slot = slot;
	}
...
struct MU_ROOMY_MATCH_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_MATCH_RESULT, sizeof(MU_ROOMY_MATCH_RESULT));
		this->scoreH = 0;
		this->scoreL = 0;
		this->total_scoreH = 0;
		this->total_scoreL = 0;
...
struct MU_ROOMY_END_RESULT
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_END_RESULT, sizeof(MU_ROOMY_END_RESULT));
		this->result = result;
	}
	PBMSG_HEAD2 h;
	uint8 result;
...
struct MU_ROOMY_CARD_LIST
{
	MU_ROOMY_CARD_LIST()
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_CARD_LIST, sizeof(MU_ROOMY_CARD_LIST));
	}
...
struct MU_ROOMY_MESSAGE
{
	...
	{
		this->h.set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_MU_ROOMY_MESSAGE, sizeof(MU_ROOMY_MESSAGE));
		this->index = index;
