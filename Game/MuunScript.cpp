...
void MuunScript::LoadDBItem(const char* ItemArray, uint32 owner, ItemBox box)
{
...
void MuunScript::LoadDBItemNew(const char* ItemArray, uint32 owner, ItemBox box)
{
	Tokenizer tokens(ItemArray, ';');
...
void MuunScript::DeleteItem(uint8 slot)
{
	...
	//this->GetPlayer()->SaveMuunDbBinary();
}
