...
constexpr char* MUUN_FILEPATH = "../Data/Muun/Muun.ini";
constexpr char* MUUN_SECTION = "Muun";
...
struct PMSG_MUUN_ITEM_GET_RECV
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_GET, sizeof(PMSG_MUUN_ITEM_GET_RECV));
	}
...
struct MUUN_MOUNT_RECV
{
	MUUN_MOUNT_RECV()
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_MOUNT, sizeof(MUUN_MOUNT_RECV));
		this->item = -1;
	}
	PBMSG_HEAD2 h;
	uint16 item;
...
struct PMSG_MUUN_ITEM_GET_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_GET, sizeof(PMSG_MUUN_ITEM_GET_SEND));
	}
...
struct PMSG_MUUN_ITEM_DUR_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_DUR, sizeof(PMSG_MUUN_ITEM_DUR_SEND));
	}
...
struct PMSG_MUUN_ITEM_DELETE_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_DELETE, sizeof(PMSG_MUUN_ITEM_DELETE_SEND));
	}
...
struct PMSG_MUUN_ITEM_MODIFY_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_MODIFY, sizeof(PMSG_MUUN_ITEM_MODIFY_SEND));
	}
...
struct PMSG_MUUN_ITEM_CHANGE_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_CHANGE, sizeof(PMSG_MUUN_ITEM_CHANGE_SEND));
	}
...
struct PMSG_MUUN_ITEM_STATUS_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_STATUS, sizeof(PMSG_MUUN_ITEM_STATUS_SEND));
	}
...
struct PMSG_MUUN_ITEM_USE_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_USE, sizeof(PMSG_MUUN_ITEM_USE_SEND));
	}
...
struct PMSG_MUUN_ITEM_SELL_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ITEM_SELL, sizeof(PMSG_MUUN_ITEM_SELL_SEND));
	}
...
struct MUUN_EXCHANGE_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_EXCHANGE, sizeof(MUUN_EXCHANGE_SEND));
		this->result = result;
	}
	PBMSG_HEAD2 h;
	uint8 result;
...
struct MUUN_ATTACK_SEND
{
	...
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_ATTACK, sizeof(MUUN_ATTACK_SEND));
		this->SetSkill(skill);
...
struct MUUN_EXPIRE_DATE
{
	MUUN_EXPIRE_DATE()
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_EXPIRE_DATE, sizeof(MUUN_EXPIRE_DATE));
		this->item = 0;
		this->slot = 0;
		this->time = 0;
	}
...
struct MUUN_EXPIRE_UPDATE
{
	MUUN_EXPIRE_UPDATE()
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_EXPIRE_UPDATE, sizeof(MUUN_EXPIRE_UPDATE));
		this->slot = 0;
		this->expire = 0;
	}
	PBMSG_HEAD2 h;
...
struct MUUN_DISPLAY_SLOT_VIEWPORT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_DISPLAY_SLOT_VIEWPORT, sizeof(MUUN_DISPLAY_SLOT_VIEWPORT));
		this->SetIndex(-1);
		this->slot = 0;
	}
...
struct MUUN_MOUNT_SINGLE
{
	MUUN_MOUNT_SINGLE()
	{
		this->h.set(HEADCODE_MUUN_DATA, SUBCODE_MUUN_MOUNT, sizeof(MUUN_MOUNT_SINGLE));
		this->count = 1;
		this->data = 0;
		this->junk = 0;
	}
...
class MuunSystem
{
	...
	public:
		...
		void LoadOption(char* pchFileName);
		void LoadEnergy(char* pchFileName);
		void LoadExchange(char* pchFileName);
