...
struct NUMERIC_BASEBALL_START : public C1_HEADER_SUB
{
	...
	{
		this->Set(HEACODE_EVENT_INVENTORY, 0x30, sizeof(NUMERIC_BASEBALL_START));
		this->result = 0;
	}
...
struct NUMERIC_BASEBALL_0x4D_0x31 : public C1_HEADER_SUB
{
	...
	{
		this->Set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_0x4D_0x31, sizeof(NUMERIC_BASEBALL_0x4D_0x31));
		this->result = 0;
	}
...
struct NUMERIC_BASEBALL_OPEN : public C1_HEADER_SUB
{
	...
	{
		this->Set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_OPEN, sizeof(NUMERIC_BASEBALL_OPEN));
		this->result = 0;
		this->junk = 0;
		this->score = 0;
...
struct NUMERIC_BASEBALL_RESULT : public C1_HEADER_SUB
{
	...
	{
		this->Set(HEACODE_EVENT_INVENTORY, SUBCODE_EVENT_INVENTORY_NUMERIC_BASEBALL_RESULT, sizeof(NUMERIC_BASEBALL_RESULT));
		this->result = 0;
		memset(this->strikes, 0, NUMERIC_BASEBALL_ROWS);
		memset(this->ball, 0, NUMERIC_BASEBALL_ROWS);
