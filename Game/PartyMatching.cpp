...
void PartyMatching::HandleSearch(Player* pPlayer, uint8 * Packet)
{
	...
	head->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_HANDLE_SEARCH, sizeof(PARTY_MATCHING_SEARCH_HEAD)+(head->count * sizeof(PARTY_MATCHING_SEARCH_BODY)));
...
void PartyMatching::HandleJoinList(Player* pPlayer, uint8 * Packet)
{
	...
	head->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_JOIN_LIST, sizeof(PARTY_MATCHING_JOIN_LIST_HEAD)+(head->count * sizeof(PARTY_MATCHING_JOIN_LIST_BODY)));
