...
struct PARTY_MATCHING_REGISTER_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_REGISTER_RESULT, sizeof(PARTY_MATCHING_REGISTER_RESULT));
		this->result = 0;
	}
...
struct PARTY_MATCHING_JOIN_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_JOIN_RESULT, sizeof(PARTY_MATCHING_JOIN_RESULT));
		this->result = 0;
...
struct PARTY_MATCHING_JOIN_DATA_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_JOIN_DATA_RESULT, sizeof(PARTY_MATCHING_JOIN_DATA_RESULT));
		memset(this->name, 0, MAX_CHARACTER_LENGTH + 1);
		memset(this->text, 0, PARTY_MATCHING_TEXT_LENGHT + 1);
	}
...
struct PARTY_MATCHING_JOIN_LIST : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_JOIN_LIST, sizeof(PARTY_MATCHING_JOIN_LIST));
	}
};
...
struct PARTY_MATCHING_ACCEPT_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_ACCEPT_RESULT, sizeof(PARTY_MATCHING_ACCEPT_RESULT));
		memset(this->name, 0, MAX_CHARACTER_LENGTH + 1);
	}
...
struct PARTY_MATCHING_CANCEL_RESULT : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_CANCEL_RESULT, sizeof(PARTY_MATCHING_CANCEL_RESULT));
	}
...
struct PARTY_MATCHING_JOIN_NOTIFY : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_JOIN_NOTIFY, sizeof(PARTY_MATCHING_JOIN_NOTIFY));
	}
};
...
struct PARTY_MATCHING_NOTIFY : C1_HEADER_SUB
{
	...
	{
		this->Set(HEADCODE_PARTY_MATCHING, SUBCODE_PARTY_MATCHING_NOTIFY, sizeof(PARTY_MATCHING_NOTIFY));
	}
