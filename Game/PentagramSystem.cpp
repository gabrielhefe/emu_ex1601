...
void PentagramSystem::LoadType(char* pchFileName)
{
	...
	pugi::xml_node Main = file.child("PentagramType");

	uint32 count = 0;

	for (pugi::xml_node penta = Main.child("Pentagram"); penta; penta = penta.next_sibling()) {

		PentagramTypeInfo* info = new PentagramTypeInfo;

		info->SetIndex(penta.attribute("Item").as_int());
		info->SetName(penta.attribute("Name").as_string());
		info->SetRate(penta.attribute("Rate").as_int());

		info->SetOption(0, penta.attribute("Option1").as_int());
		info->SetOption(1, penta.attribute("Option2").as_int());
		info->SetOption(2, penta.attribute("Option3").as_int());
		info->SetOption(3, penta.attribute("Option4").as_int());
		info->SetOption(4, penta.attribute("Option5").as_int());
		info->SetOption(5, penta.attribute("Option6").as_int());
		info->SetOption(6, penta.attribute("Option7").as_int());
...
void PentagramSystem::LoadOption(char* pchFileName)
{
	...
	pugi::xml_node Main = file.child("PentagramOption");
	...
	for (pugi::xml_node option = Main.child("Option"); option; option = option.next_sibling()) {
		...
		info->SetIndex(option.attribute("ID").as_int());
		info->SetName(option.attribute("Name").as_string());
		info->SetValue(option.attribute("Value").as_int());

		info->SetType(0, option.attribute("Type1").as_int());
		info->SetRank(0, option.attribute("Rank1").as_int());
		info->SetLevel(0, option.attribute("Level1").as_int());
		info->SetType(1, option.attribute("Type2").as_int());
		info->SetRank(1, option.attribute("Rank2").as_int());
		info->SetLevel(1, option.attribute("Level2").as_int());
		info->SetType(2, option.attribute("Type3").as_int());
		info->SetRank(2, option.attribute("Rank3").as_int());
		info->SetLevel(2, option.attribute("Level3").as_int());
		info->SetType(3, option.attribute("Type4").as_int());
		info->SetRank(3, option.attribute("Rank4").as_int());
		info->SetLevel(3, option.attribute("Level4").as_int());
		info->SetType(4, option.attribute("Type5").as_int());
		info->SetRank(4, option.attribute("Rank5").as_int());
		info->SetLevel(4, option.attribute("Level5").as_int());
...
void PentagramSystem::LoadJewelOption(char* pchFileName)
{
	...
	pugi::xml_node Main = file.child("PentagramJewelOption");

	for (pugi::xml_node option = Main.child("Option"); option; option = option.next_sibling()) {
		ErrtelOption* info = new ErrtelOption;

		info->SetIndex(option.attribute("Index").as_int());
		info->SetItem(ITEMGET(option.attribute("ItemCat").as_int(), option.attribute("ItemIndex").as_int()));
		info->SetRankNumber(option.attribute("RankNumber").as_int());
		info->SetRankOption(option.attribute("RankOption").as_int());
		info->SetRate(option.attribute("Rate").as_int());

		info->SetValue(0, option.attribute("Value0").as_int());
		info->SetValue(1, option.attribute("Value1").as_int());
		info->SetValue(2, option.attribute("Value2").as_int());
		info->SetValue(3, option.attribute("Value3").as_int());
		info->SetValue(4, option.attribute("Value4").as_int());
		info->SetValue(5, option.attribute("Value5").as_int());
		info->SetValue(6, option.attribute("Value6").as_int());
		info->SetValue(7, option.attribute("Value7").as_int());
		info->SetValue(8, option.attribute("Value8").as_int());
		info->SetValue(9, option.attribute("Value9").as_int());
		info->SetValue(10, option.attribute("Value10").as_int());
		info->SetUpgradeRate(0, option.attribute("UpgradeRate0").as_int());
		info->SetUpgradeRate(1, option.attribute("UpgradeRate1").as_int());
		info->SetUpgradeRate(2, option.attribute("UpgradeRate2").as_int());
		info->SetUpgradeRate(3, option.attribute("UpgradeRate3").as_int());
		info->SetUpgradeRate(4, option.attribute("UpgradeRate4").as_int());
		info->SetUpgradeRate(5, option.attribute("UpgradeRate5").as_int());
		info->SetUpgradeRate(6, option.attribute("UpgradeRate6").as_int());
		info->SetUpgradeRate(7, option.attribute("UpgradeRate7").as_int());
		info->SetUpgradeRate(8, option.attribute("UpgradeRate8").as_int());
		info->SetUpgradeRate(9, option.attribute("UpgradeRate9").as_int());
		info->SetUpgradeRate(10, option.attribute("UpgradeRate10").as_int());

		info->SetName(option.attribute("Name").as_string());
		info->SetVariableType(option.attribute("VariableType").as_int());
		info->SetType(0);
...
void PentagramSystem::LoadJewelRemove(char* pchFileName)
{
	...
	pugi::xml_node Main = file.child("PentagramJewelRemove");
	...
	for (pugi::xml_node option = Main.child("Option"); option; option = option.next_sibling()) {
		...
		info->SetMixRate(0, option.attribute("MixRate1").as_int());
		info->SetMixRate(1, option.attribute("MixRate2").as_int());
		info->SetMixRate(2, option.attribute("MixRate3").as_int());
		info->SetMixRate(3, option.attribute("MixRate4").as_int());
		info->SetMixRate(4, option.attribute("MixRate5").as_int());
...
void PentagramSystem::LoadJewelUpgrade(char* pchFileName)
{
	...
	pugi::xml_node Main = file.child("PentagramJewelUpgrade");
	pugi::xml_node UpgradeRank = Main.child("UpgradeRank");
	pugi::xml_node UpgradeLevel = Main.child("UpgradeLevel");

	for (pugi::xml_node option = UpgradeRank.child("Upgrade"); option; option = option.next_sibling()) {
		PentagramJewelUpgradeRankInfo* info = new PentagramJewelUpgradeRankInfo;

		info->SetIndex(option.attribute("Index").as_int());
		info->SetMixMoney(option.attribute("MixCost").as_int());
		info->SetMixRate(option.attribute("MixRate").as_int());
	...
	for (pugi::xml_node option = UpgradeLevel.child("Upgrade"); option; option = option.next_sibling()) {
		...
		info->SetRequiredElementalRune(0, option.attribute("ElementRune1").as_int());
		info->SetRequiredElementalRune(1, option.attribute("ElementRune2").as_int());
		info->SetRequiredElementalRune(2, option.attribute("ElementRune3").as_int());
		info->SetRequiredElementalRune(3, option.attribute("ElementRune4").as_int());
		info->SetRequiredElementalRune(4, option.attribute("ElementRune5").as_int());
...
{
	Item* pentagram = pPlayer->GetInventory()->GetItem(PENTAGRAM_SLOT);

	if (!pentagram || !pentagram->IsPentagramItem()) {
		pPlayer->SendNotice(CUSTOM_MESSAGE_ID_RED, "No Item");
		return false;
	}
	...
	for (int32 n = 0; n < MAX_SOCKET_SLOT; ++n)
	{
		...
		{
			PentagramJewelInfo const* pPentagramJewelInfo = this->GetPentagramJewelInfo(pPlayer, pentagram->GetSocket(pInfo->GetType(n)) & 0xFF, PENTAGRAM_JEWEL_TYPE_INVENTORY);
			...
			if (!pPlayer->ItemFind(ITEMGET(pPentagramJewelInfo->GetItemSection(), pPentagramJewelInfo->GetItemType()), 0, false)) {
				return false;
			}
...
void PentagramSystem::GCPentagramJewelInfoSend(Player* pPlayer, uint8 type)
{
	...
	head->Set(HEADCODE_PENTAGRAM_ERRTEL, SUBCODE_PENTAGRAM_ERRTEL_DATA, sizeof(PENTAGRAM_ERRTEL_DATA_HEAD)+(head->count * sizeof(PENTAGRAM_ERRTEL_DATA_BODY)));
