...
void PersonalStoreScript::AssignItem(Item const& add_item, uint32 slot)
{
	...
	this->GetItem(slot)->SetBox(ITEM_BOX_PERSONAL_STORE);
...
void PersonalStoreScript::LoadDBItem(const char* ItemArray, uint32 owner, ItemBox box)
{
...
void PersonalStoreScript::LoadDBItemNew(const char* ItemArray, uint32 owner, ItemBox box)
{
	Tokenizer tokens(ItemArray, ';');
