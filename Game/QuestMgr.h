...
class CQuestMgr
{
	...
	public:
		...
		void LoadQuestEvolution(char* pchFileName);
		void LoadQuestEvolutionData(char* pchFileName);
		void LoadQuestEvolutionCondition(char* pchFileName);
		void LoadQuestEvolutionItemReward(char* pchFileName);
		void LoadQuestGuided(char *pchFileName);
		void LoadQuestMU(char *pchFileName);
