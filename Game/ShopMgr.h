...
class Shop
{
	...
	public:
		...
		DECLARE_PROPERTY_STRING(FileScriptsName);
};
...
class ShopMgr
{
	...
	public:
		...
		void LoadShopTemplate(char* pchFileName);
		void LoadShopItems(const char* pchFileName, uint8 ShopID);
		void LoadShopScripts();
