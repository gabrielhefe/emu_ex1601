...
struct skill_template
{
	...
	DECLARE_PROPERTY_ARRAY(int64, RequiredStat, MAX_STAT_TYPE);
...
class SkillMgr
{
	...
	public:
		...
		void LoadSkillTemplate(char* pchFileName);
		void LoadSkillLearn(char* pchFileName);
		void LoadSkillTree(char* pchFileName);
		void LoadSkillSpecial(char* pchFileName);
		void LoadSkillSpecialElement(char* pchFileName);
		void LoadBuffTemplate(char* pchFileName);
		void LoadSkillRequire(char* pchFileName);
		void LoadSkillTreeMajestic(char* pchFileName);
		void LoadSkillTreeMajesticStat(char* pchFileName);
		void LoadSkillAttackTime(char* pchFileName);
