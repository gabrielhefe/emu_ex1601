...
constexpr char* TORMENTEDSQUARE_FILEPATH = "../Data/Event/TormentedSquare/TormentedSquare.ini";
constexpr char* TORMENTEDSQUARE_SECTION = "TormentedSquare";
...
struct TORMENTED_SQUARE_ROUND_DATA
{
	...
	{
		this->h.set(HEADCODE_TORMENTED_SQUARE, SUBCODE_TORMENTED_SQUARE_TIME, sizeof(TORMENTED_SQUARE_ROUND_DATA));
		this->remain_time = 0;
		this->unk = 0;
...
class TormentedSquare
{
	...
	public:
		...
		void LoadRanking(char* pchFileName);
