...
public:
	...
	struct BloodCastleAI: public MonsterAI
	{
		...
		void OnDie()
		{
			...
			if ( BloodCastle * Ground = sBloodCastleMgr->GetGround(me()->GetEventGround()) )
			{
				Player* pPlayerKiller = sObjectMgr->FindPlayerByName(me()->GetLastAttacker()->GetName());
				Ground->ProcessDoorDestroyed(pPlayerKiller, me());
			}
		}
...
public:
	...
	struct BloodCastleAI: public MonsterAI
	{
		...
		void OnDie()
		{
			...
			{
				Player* pPlayerKiller = sObjectMgr->FindPlayerByName(me()->GetLastAttacker()->GetName());
				Ground->ProcessStatueDestroyed(pPlayerKiller, me());
			}
		}
